...
/**
 * CancelPolicyRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CancelPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelPolicyRequest';
    ...
    protected static $openAPITypes = [
        ...
        'reason' => '\OpenAPI\Client\Model\CancellationReason',
        'is_external_number' => 'bool',
        'request_id' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'reason' => 'reason',
        'is_external_number' => 'is_external_number',
    ...
    protected static $setters = [
        ...
        'reason' => 'setReason',
        'is_external_number' => 'setIsExternalNumber',
    ...
    protected static $getters = [
        ...
        'reason' => 'getReason',
        'is_external_number' => 'getIsExternalNumber',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_external_number'] = $data['is_external_number'] ?? null;
     ...
     * Gets reason
     *
     * @return \OpenAPI\Client\Model\CancellationReason
     */
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Model\CancellationReason $reason reason
     *
     * @return self
     */
    ...
    /**
     * Gets is_external_number
     *
     * @return bool|null
     */
    public function getIsExternalNumber()
    {
        return $this->container['is_external_number'];
    }

    /**
     * Sets is_external_number
     *
     * @param bool|null $is_external_number If true, provided ID will be matched against the external policy ID instead of simplesurance policy number.
     *
     * @return self
     */
    public function setIsExternalNumber($is_external_number)
    {
        $this->container['is_external_number'] = $is_external_number;
     ...
     * Sets request_id
     *
     * @param string|null $request_id Unique request identifier. Repeated requests with the same id will not be processed multiple times, but cached response will be returned instead.
     *
     * @return self
     */
