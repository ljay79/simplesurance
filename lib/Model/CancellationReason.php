 ...
 *
 * @category Class
 * @description Available cancellation reasons will be provided to the partner by simplesurance.
 * @package  SiSu\Client
 * @author   SiSu Generator team
 * @link     https://openapi-generator.tech
 */
class CancellationReason
{
    ...
    const SPECIAL_TERMINATION = 'SPECIAL_TERMINATION';
    const PARTNER_CANCEL = 'PARTNER_CANCEL';
    const FRAUD = 'FRAUD';
