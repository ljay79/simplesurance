...
/**
 * TravellerBaseInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TravellerBaseInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravellerBaseInfo';
    ...
    const EXTRAS_WINTER_SPORTS = 'WINTER_SPORTS';
    const EXTRAS_CRUISE_COVER = 'CRUISE_COVER';
    const EXTRAS_WEDDING_COVER = 'WEDDING_COVER';
    const EXTRAS_GOLF_COVER = 'GOLF_COVER';
     ...
     * @return string[]
     */
    public function getExtrasAllowableValues()
    {
        return [
            self::EXTRAS_WINTER_SPORTS,
            self::EXTRAS_CRUISE_COVER,
            self::EXTRAS_WEDDING_COVER,
            self::EXTRAS_GOLF_COVER,
        ];
    }
     ...
     * Sets extras
     *
     * @param string[]|null $extras Additional cover which can be purchased on top of the initial insurance package (eg. ski cover).
     *
     * @return self
     */
    public function setExtras($extras)
    {
        $allowedValues = $this->getExtrasAllowableValues();
        if (!is_null($extras) && array_diff($extras, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'extras', must be one of '%s'",
     ...
     * Sets date_of_birth
     *
     * @param \OpenAPI\Client\Model\UpdatedAt $date_of_birth date_of_birth
     *
     * @return self
     */
