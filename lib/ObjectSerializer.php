...
use SiSu\Client\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     * @param string $type   the SiSuToolsType of the data
     * @param string $format the format of the SiSuTools type of the data
     *
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\SiSu\Client\Model\\' . $data->{$discriminator};
