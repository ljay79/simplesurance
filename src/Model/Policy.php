...
class Policy implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tariff_name'] = $data['tariff_name'] ?? null;
    }
     ...
     *
     * @param \SiSu\Client\Model\Items[]|null $insured_objects insured_objects
     *
     * @return self
     */
     ...
     * Sets tariff_name
     *
     * @param string|null $tariff_name Display name of the product which is translated into the customer's local language.
     *
     * @return self
     */
